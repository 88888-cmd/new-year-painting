...
import 'package:app/pages/goodsComment/controller.dart';
...
class _GoodsCommentPageState extends State<GoodsCommentPage> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<GoodsCommentController>(
      init: GoodsCommentController(),
      ...
      builder: (controller) => Scaffold(
        ...
        body: ListView.builder(
          ...
          itemBuilder: (context, index) {
            GoodsCommentModel goodsCommentModel = controller.commentList[index];
