...
import 'package:app/pages/addStoryPostsFirst/controller.dart';
...
class AddStoryPostsFirstPage extends StatefulWidget {
  const AddStoryPostsFirstPage({super.key});

  @override
  State<AddStoryPostsFirstPage> createState() => _AddStoryPostsFirstPageState();
}

class _AddStoryPostsFirstPageState extends State<AddStoryPostsFirstPage> {
  ...
  void _showAllFiltersDialog(SelectPaintingFirstController controller) {
  ...
  bool _hasActiveFilters(SelectPaintingFirstController controller) {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SelectPaintingFirstController>(
      init: SelectPaintingFirstController(),
      builder:
          (controller) => Scaffold(
            appBar: AppBar(title: Text(LocaleKeys.tabbar_painting.tr)),
            body:
                controller.isIniting
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: PrimaryButton(
                      width: double.infinity,
                      title: LocaleKeys.next_step.tr,
                      onPressed: () {
                        if (controller.selectedPainting == null) return;

                        Get.off(
                          AddStoryPostsPage(),
                          // Routes.addStoryPosts,
                          arguments: {
                            'id': controller.selectedPainting!.id,
                            'image_url': controller.selectedPainting!.image_url,
                            'name': controller.selectedPainting!.name,
                            'author': controller.selectedPainting!.author,
                          },
                        );
                      },
                    ),
