...
import 'package:app/pages/selectPainting/controller.dart';
...
class SelectPaintingPage extends StatefulWidget {
  const SelectPaintingPage({super.key});

  @override
  State<SelectPaintingPage> createState() => _SelectPaintingPageState();
}

class _SelectPaintingPageState extends State<SelectPaintingPage> {
  ...
  void _showAllFiltersDialog(SelectPaintingController controller) {
  ...
  bool _hasActiveFilters(SelectPaintingController controller) {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SelectPaintingController>(
      init: SelectPaintingController(),
      global: false,
      builder:
          (controller) => Scaffold(
                      ...
                      onPressed: () {
                        ...
                        Get.back(
                          result: {
                            ...
                            'content': controller.selectedPainting!.content,
                          },
                        );
                      },
                    ),
