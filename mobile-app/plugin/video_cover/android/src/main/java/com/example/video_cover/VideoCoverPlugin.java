package com.example.video_cover;
...
public class VideoCoverPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        ...
        channel = new MethodChannel(binding.getBinaryMessenger(), "video_cover");
