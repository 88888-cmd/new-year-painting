<template>
    <div>
        <el-card class="form-container" shadow="never">
            <aside style="margin-bottom: 20px">编辑年画</aside>
...
<script>
import { detail, edit, getFilterOptions } from "@/api/painting";
    ...
    methods: {
        async fetchData() {
            ...
            try {
                ...
                this.styleList = filterOptionsResult.data.styles;
                this.themeList = filterOptionsResult.data.themes;
                this.dynastyList = filterOptionsResult.data.dynasties;
                this.authorList = filterOptionsResult.data.authors;
        ...
        clickSubmit() {
            ...
            edit({ painting_id: this.$route.params.id, ...this.form })
                .then((response) => {
                    this.$message({
                        message: "编辑成功",
                        type: "success",
